<?php
class ControllerPrilTaskfull extends Controller {
	public function index() {
		...
		if ($house['Result'] == 'OK') {
			...
			print_r (STATEIDCLOSE."djkgjdksfgjkldsfjg".$task."djkgjdksfgjkldsfjg".$task_related."djkgjdksfgjkldsfjg".$house_arr."djkgjdksfgjkldsfjg".$description_type_task);
